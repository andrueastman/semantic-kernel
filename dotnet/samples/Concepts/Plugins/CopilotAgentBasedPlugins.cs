...
public class CopilotAgentBasedPlugins(ITestOutputHelper output) : BaseTest(output)
{
    ...
    {
        if (("me_sendMail".Equals(context.Operation.Id, StringComparison.OrdinalIgnoreCase) || "me_calendar_CreateEvents".Equals(context.Operation.Id, StringComparison.OrdinalIgnoreCase))
